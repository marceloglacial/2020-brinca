<?php
/**
 * The global video transformations settings tab HTML.
 *
 * @package Cloudinary
 */
...
?>
<p><?php esc_html_e( 'Define the global (default) transformations to be applied to all videos. You can override these transformations with transformations applied at category, tag or individual level. See documentation for more information.', 'cloudinary' ); ?></p>
