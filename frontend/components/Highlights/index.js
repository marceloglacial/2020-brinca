        ...
        <Container className='p-5'>
          ...
          <Row>
            <Col className='text-center'>
              <Image src='/uploads/union.jpeg' className='mb-3' fluid />
              <h4>União</h4>
              <p>Integrando a comunidade Brasileira em Ottawa-Gatineau</p>
            </Col>
            <Col className='text-center'>
              <Image src='/uploads/collab.jpeg' className='mb-3' fluid />

              <h4>Colaboração</h4>
              <p>Apoiando o crescimento das famílias Brasileiras</p>
            </Col>
            <Col className='text-center'>
              <Image src='/uploads/diversitty.jpg' className='mb-3' fluid />
